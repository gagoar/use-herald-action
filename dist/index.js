...
var require_package = __commonJS((exports, module2) => {
  module2.exports = {
    _args: [
      [
        "estraverse@4.3.0",
        "/Users/gfrigerio/base/use-herald"
      ]
    ],
...
var require_estraverse = __commonJS((exports) => {
  (function clone(exports2) {
    ...
    function attachComments(tree, providedComments, tokens) {
      var comments = [], comment2, len, i, cursor;
      if (!tree.range) {
...
var require_escodegen = __commonJS((exports) => {
  (function() {
    ...
    function addComments(stmt, result) {
      var i, len, comment2, save, tailingToStatement, specialBase, fragment, extRange, range, prevRange, prefix, infix, suffix, count;
    ...
    CodeGenerator.Statement = {
      ...
      ThrowStatement: function(stmt, flags) {
        return [join2("throw", this.generateExpression(stmt.argument, Precedence.Sequence, E_TTT)), this.semicolon(flags)];
      },
      ...
      ReturnStatement: function(stmt, flags) {
        if (stmt.argument) {
          return [join2("return", this.generateExpression(stmt.argument, Precedence.Sequence, E_TTT)), this.semicolon(flags)];
        }
    ...
    CodeGenerator.Expression = {
      ...
      AwaitExpression: function(expr, precedence, flags) {
        var result = join2(expr.all ? "await*" : "await", this.generateExpression(expr.argument, Precedence.Await, E_TTT));
    ...
    var eq = function(a, b, aStack, bStack) {
      ...
      if (className === "[object Array]") {
        ...
        if (result2) {
          while (size--) {
            key = keys[size];
            if (!(result2 = _.has(b, key) && eq(a[key], b[key], aStack, bStack)))
              break;
          }
        }
      }
