            ...
            (function (root, factory) {
              ...
              SyntaxTreeDelegate = {
                ...
                processComment: function (node) {
                  ...
                  if (extra.trailingComments.length > 0) {
                    ...
                    if (
                      ...
                      extra.bottomRightStack[extra.bottomRightStack.length - 1].trailingComments[0].range[0] >=
                        node.range[1]
                    ) {
                  ...
                  while (
                    extra.bottomRightStack.length > 0 &&
                    extra.bottomRightStack[extra.bottomRightStack.length - 1].range[0] >= node.range[0]
                  ) {
                  ...
                  if (lastChild) {
                    if (
                      ...
                      lastChild.leadingComments[lastChild.leadingComments.length - 1].range[1] <= node.range[0]
                    ) {
                    ...
                    extra.leadingComments[extra.leadingComments.length - 1].range[1] <= node.range[0]
                  ) {
                ...
                markEnd: function (node, startToken) {
                  ...
                  if (extra.loc) {
                    node.loc = new SourceLocation(
                      ...
                      startToken.start -
                        (startToken.startLineStart === void 0 ? startToken.lineStart : startToken.startLineStart),
                      lineNumber,
                      index - lineStart
                    );
                ...
                createBinaryExpression: function (operator, left, right) {
                  var type =
                    operator === '||' || operator === '&&' ? Syntax.LogicalExpression : Syntax.BinaryExpression;
                  return {
                    type,
                    operator,
                    left,
              ...
              function throwError(token, messageFormat) {
                var error,
                  ...
                  msg = messageFormat.replace(/%(\d)/g, function (whole, index2) {
                    ...
                    switch (yystate) {
                      ...
                      case 4:
                        yy.ast.set({
                          operation: 'member',
                          scope: 'child',
                          expression: { type: 'identifier', value: $$[$0 - 1] },
                        });
                        yy.ast.unshift();
                        return yy.ast.yield();
                        break;
                      ...
                      case 24:
                        $$[$0].length > 1
                          ? yy.ast.set({ expression: { type: 'union', value: $$[$0] } })
                          : (this.$ = $$[$0]);
                        break;
                      case 25:
                        this.$ = [$$[$0]];
        ...
        8: [
          function (require2, module4, exports3) {
            ...
            function getMessage(self2) {
              return (
                truncate(JSON.stringify(self2.actual, replacer), 128) +
                ' ' +
                self2.operator +
                ' ' +
                truncate(JSON.stringify(self2.expected, replacer), 128)
              );
            }
            ...
            (function (process2, global2) {
              ...
              function formatValue(ctx, value, recurseTimes) {
                if (
                  ...
                  value.inspect !== exports3.inspect &&
          ...
          function (require2, module4, exports3) {
            (function (process2) {
              ...
              exports3.normalize = function (path3) {
                var isAbsolute = exports3.isAbsolute(path3),
                  trailingSlash = substr(path3, -1) === '/';
                path3 = normalizeArray(
                  filter(path3.split('/'), function (p) {
                    return !!p;
                  }),
                  !isAbsolute
                ).join('/');
              ...
              exports3.dirname = function (path3) {
                if (typeof path3 !== 'string') path3 = path3 + '';
              ...
              var substr =
                'ab'.substr(-1) === 'b'
                  ...
                  : function (str2, start, len) {
                      if (start < 0) start = str2.length + start;
                      return str2.substr(start, len);
                    };
            }.call(this, require2('_process')));
          },
