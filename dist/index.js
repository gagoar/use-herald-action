...
var require_tunnel = __commonJS({
  "node_modules/tunnel/lib/tunnel.js"(exports2) {
    ...
    TunnelingAgent.prototype.createSocket = function createSocket(options, cb) {
      ...
      debug11("making CONNECT request");
      ...
      function onConnect(res, socket, head) {
        ...
        if (res.statusCode !== 200) {
          debug11("tunneling socket could not be established, statusCode=%d", res.statusCode);
          socket.destroy();
        ...
        if (head.length > 0) {
          debug11("got illegal response body from proxy");
          socket.destroy();
        ...
        debug11("tunneling connection has established");
        self2.sockets[self2.sockets.indexOf(placeholder)] = socket;
        return cb(socket);
      }
      function onError(cause) {
        connectReq.removeAllListeners();
        debug11("tunneling socket could not be established, cause=%s\n", cause.message, cause.stack);
...
var require_constants2 = __commonJS({
  "node_modules/fast-glob/node_modules/picomatch/lib/constants.js"(exports2, module2) {
    "use strict";
    var path = require("path");
    var WIN_SLASH = "\\\\/";
...
var require_utils3 = __commonJS({
  "node_modules/fast-glob/node_modules/picomatch/lib/utils.js"(exports2) {
    "use strict";
    var path = require("path");
...
var require_scan = __commonJS({
  "node_modules/fast-glob/node_modules/picomatch/lib/scan.js"(exports2, module2) {
    "use strict";
...
var require_parse2 = __commonJS({
  "node_modules/fast-glob/node_modules/picomatch/lib/parse.js"(exports2, module2) {
    "use strict";
...
var require_picomatch = __commonJS({
  "node_modules/fast-glob/node_modules/picomatch/lib/picomatch.js"(exports2, module2) {
    "use strict";
    var path = require("path");
...
var require_picomatch2 = __commonJS({
  "node_modules/fast-glob/node_modules/picomatch/index.js"(exports2, module2) {
    "use strict";
...
var require_micromatch = __commonJS({
  "node_modules/fast-glob/node_modules/micromatch/index.js"(exports2, module2) {
    ...
    micromatch.contains = (str2, pattern, options) => {
      ...
      return micromatch.isMatch(str2, pattern, __spreadProps(__spreadValues({}, options), { contains: true }));
    };
...
var require_validators = __commonJS({
  "node_modules/envalid/src/validators.js"(exports2) {
...
var require_utils6 = __commonJS({
  "node_modules/envalid/src/utils.js"(exports2) {
...
var require_util = __commonJS({
  "node_modules/envalid/node_modules/chalk/source/util.js"(exports2, module2) {
    "use strict";
...
var require_templates = __commonJS({
  "node_modules/envalid/node_modules/chalk/source/templates.js"(exports2, module2) {
    "use strict";
...
var require_source = __commonJS({
  "node_modules/envalid/node_modules/chalk/source/index.js"(exports2, module2) {
    "use strict";
...
var require_reporter = __commonJS({
  "node_modules/envalid/src/reporter.js"(exports2, module2) {
...
var require_meant = __commonJS({
  "node_modules/meant/index.js"(exports2, module2) {
...
var require_strictProxy = __commonJS({
  "node_modules/envalid/src/strictProxy.js"(exports2, module2) {
...
var require_envalidWithoutDotenv = __commonJS({
  "node_modules/envalid/src/envalidWithoutDotenv.js"(exports2, module2) {
    var {
      EnvError,
      EnvMissingError,
      makeValidator,
...
var require_envalid = __commonJS({
  "node_modules/envalid/src/envalid.js"(exports2, module2) {
...
var require_jsonpath = __commonJS({
  "node_modules/jsonpath/jsonpath.js"(exports2, module2) {
    (function(f) {
  ...
  static loadFromLocation(location) {
    ...
    const rules = matches.reduce((memo2, filePath) => {
      try {
        ...
        return isValidRawRule(rule) ? [...memo2, __spreadProps(__spreadValues({ name: (0, import_path2.basename)(filePath) }, sanitize(rule)), { path: filePath })] : memo2;
      } catch (e) {
  ...
  static async load(rules, files, event, patchContent = []) {
    ...
    const matchingRules = rules.map((rule) => {
      return queue.add(async () => {
        ...
        return __spreadProps(__spreadValues({}, rule), { matched });
      });
    });
...
var composeCommentsForUsers = (matchingRules) => {
  ...
  if (groups[TypeOfComments.combined]) {
    ...
    comments = __spreadProps(__spreadValues({}, comments), { [COMBINED_TAG_KEY]: commentTemplate([...new Set(mentions)]) });
  }
  if (groups[TypeOfComments.standalone]) {
    const customMessages = groups[TypeOfComments.standalone].filter((rule) => rule.customMessage).reduce((memo2, { path, customMessage }) => __spreadProps(__spreadValues({}, memo2), { [path]: customMessage }), {});
    comments = __spreadValues(__spreadValues({}, comments), customMessages);
  }
  return comments;
};
var getAllComments = async (client, params) => {
  const page = 1;
  const { data: comments } = await client.issues.listComments(__spreadProps(__spreadValues({}, params), {
    per_page: maxPerPage,
    page
  }));
  if (comments.length < maxPerPage) {
    ...
    const { data: moreComments } = await client.issues.listComments(__spreadProps(__spreadValues({}, params), {
      page: page + 1,
      per_page: maxPerPage
    }));
...
var handleComment = async (client, { owner, repo, prNumber, matchingRules, files, base }, requestConcurrency = 1) => {
  ...
  const rulesWithBlobURL = matchingRules.map((mRule) => __spreadProps(__spreadValues({}, mRule), {
  ...
  const useHeraldActionComments = rawComments.reduce((memo2, comment) => {
    ...
    return pathMatch ? __spreadProps(__spreadValues({}, memo2), { [pathMatch[1]]: comment }) : memo2;
  }, {});
...
var getParams = () => {
  return Object.keys(Props).reduce((memo2, prop) => {
    ...
    return value ? __spreadProps(__spreadValues({}, memo2), { [prop]: value }) : memo2;
  }, {});
};
var main = async () => {
  try {
