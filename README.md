...
| `includes`      | `string` \| `string[]` |    No    | Glob pattern used to match changed filenames in the pull request                                                                                                                          |
| `excludes`      | `string` \| `string[]` |    No    | Glob pattern used to exclude chnaged filenames (requires `includes` key to be provided)                                                                                                   |
