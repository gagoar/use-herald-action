...
| `action`          |        `string`        |   Yes    | Currently, supported actions are `comment`, `review`, `assign` and `label`                                                                                                                                                                               |
...
| `labels`          |       `string[]`       |    No    | Github labels which the rule will take action. Only valid when `action` field is set to `label`                                                                                                                                                          |
